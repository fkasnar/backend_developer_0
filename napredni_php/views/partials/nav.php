    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="/borrow" class="nav-link px-2 <?= setActiveCalss('borrow') ?>" <?= setAriaCurent("borrow") ?>>Posudbe</a></li>
                ...
                <li><a href="/media" class="nav-link px-2 <?= setActiveCalss('media') ?>" <?= setAriaCurent("media") ?>>Mediji</a></li>
