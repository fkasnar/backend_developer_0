    ...
    <table class="table table-striped">
        ...
        <tbody>
            <?php foreach ($prices as $price): ?>
                <tr>
                    <td>
                        <a href="/prices/show?id=<?= $price['id'] ?>"><?= $price['id'] ?></a>
                    </td>
                    <td><?= $price['tip_filma'] ?></td>
                    <td><?= $price['cijena'] ?></td>
                    <td><?= $price['zakasnina_po_danu'] ?></td>
                    <td>
                        <a href="/prices/edit?id=<?= $price['id'] ?>" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit price"><i class="bi bi-pencil"></i></a>
